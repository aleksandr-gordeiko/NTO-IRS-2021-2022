...
def main():
    ...
    while True:
        try:
            bricks, red_stack_height, blue_stack_height, dif_z = analyze_image(cam, rob, previous_brick=None)
            while len(bricks) != 0:
                ...
                rob.stack_object(red_stack_height, blue_stack_height, dif_z, brick.color)
            rob.close()
            break
        except ValueError:
